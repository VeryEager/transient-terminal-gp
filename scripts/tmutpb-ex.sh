...
#
python test-tmutpb.py winequality-red quality \; 
#python test-tmutpb.py winequality-white quality \; 
#python test-tmutpb.py strength-concrete csMPa \, 
#python test-tmutpb.py houseprice-boston MEDV \, 
